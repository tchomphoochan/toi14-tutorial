...
_เขียนโดย aquablitz11_

เนื่องจาก Dynamic Programming เป็นแนวทางการแก้ปัญหาที่มีขอบเขตค่อนข้างกว้าง ดังนั้นจึงมีโจทย์ DP หลายประเภทย่อยที่ผู้เข้าแข่่งขันต้องฝึกฝน ทำความรู้จักคุ้นเคยกับวิธีการประยุกต์แต่ละรูปแบบเข้าด้วยกัน ในที่นี้จะขอกล่าวถึงรูปแบบการใช้แนวคิด Dynamic Programming หลายรูปแบบที่พบบ่อย

**Prefix/Suffix Dynamic Programming**

เป็นการกำหนด state ในลักษณะที่สนใจเฉพาะส่วนต้นหรือส่วนปลายของปัญหาเท่านั้น เช่น ปัญหา Maximium Independent Set (MIS)
